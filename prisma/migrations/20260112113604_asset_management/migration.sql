...
-- CreateIndex
CREATE UNIQUE INDEX "asset_storageKey_key" ON "public"."asset"("storageKey");

-- CreateIndex
CREATE INDEX "asset_visibility_idx" ON "public"."asset"("visibility");

-- CreateIndex
CREATE INDEX "asset_createdBy_idx" ON "public"."asset"("createdBy");

-- CreateIndex
CREATE INDEX "asset_deletedAt_idx" ON "public"."asset"("deletedAt");

-- CreateIndex
CREATE INDEX "asset_expiresAt_idx" ON "public"."asset"("expiresAt");

-- CreateIndex
CREATE INDEX "asset_permission_userId_idx" ON "public"."asset_permission"("userId");

-- CreateIndex
CREATE INDEX "asset_permission_assetId_idx" ON "public"."asset_permission"("assetId");

-- CreateIndex
CREATE UNIQUE INDEX "asset_permission_assetId_userId_action_key" ON "public"."asset_permission"("assetId", "userId", "action");

-- CreateIndex
CREATE INDEX "asset_link_entityType_entityId_idx" ON "public"."asset_link"("entityType", "entityId");
